...
def main():
    ...
    # Сохраняем в PDF
    output_path = 'papers_general/figures/weights_comparison.pdf'
    plt.savefig(output_path, format='pdf', bbox_inches='tight')
    print(f"График сохранён в {output_path}")
    
    # Также сохраним PNG для превью
    plt.savefig('papers_general/figures/weights_comparison.png', format='png', bbox_inches='tight', dpi=150)
    print("PNG превью сохранено в papers_general/figures/weights_comparison.png")
